...
@section('content')
    ...
    <section class="flex md:justify-center items-center md:h-[100vh] bg-gradient-to-t from-soft to-white">
        <div class="w-full p-5">
            <form action="{{ route('inputData') }}" method="POST" enctype="multipart/form-data" class="flex flex-col md:items-center gap-2">
                @csrf
                ...
                <div class="flex flex-col justify-center md:flex-row md:px-12 gap-5 w-full">
                    ...
                    <div class="flex flex-col gap-5 lg:w-2/4">
                        <div class="flex flex-col gap-3">
                            <label for="nama_lengkap" class="text-sm">Nama Lengkap <span class="text-red-500">*</span></label>
                            <input type="text" name="nama_lengkap" id="nama_lengkap" class="rounded-2xl w-full lg:h-12"
                                required>
                        </div>
                        <div class="flex flex-col gap-3">
                            <label for="datepicker-autohide" class="text-sm">Tanggal Lahir <span class="text-red-500">*</span></label>
                            <div class="relative max-w-full">
                                ...
                                <input id="datepicker-autohide" datepicker datepicker-autohide type="text" name="tanggal_lahir"
                    ...
                    <div class="flex flex-col gap-5 lg:w-2/4">
                        <div class="flex flex-col gap-3">
                            ...
                            <input type="text" name="kelurahan" id="kelurahan" class="rounded-2xl w-full lg:h-12" required>
                        </div>
                        <div class="flex flex-col gap-3">
                            <label for="kecamatan" class="text-sm">Kecamatan <span class="text-red-500">*</span></label>
                            <input type="text" name="kecamatan" id="kecamatan" class="rounded-2xl w-full lg:h-12" required>
                        </div>
                        <div class="flex flex-col gap-3">
                            <label for="kabupaten" class="text-sm">Kabupaten <span class="text-red-500">*</span></label>
                            <input type="text" name="kabupaten" id="kabupaten" class="rounded-2xl w-full lg:h-12" required>
                        </div>
                    </div>
                </div>
