<aside :class="sidebarToggle ? 'translate-x-0' : '-translate-x-full'"
    ...
    <div class="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <a href="index.html">
            <img src="{{ asset('assets/logo/logo-pendekar.png') }}" alt="Logo" />
        </a>
    </div>
    <!-- SIDEBAR HEADER -->
        ...
        <nav class="mt-5 px-4 py-4 lg:mt-9 lg:px-6" x-data="{ selected: ('Dashboard') }">
            ...
            <div>
                ...
                <ul class="mb-6 flex flex-col gap-1.5">
                    ...
                    <!-- Menu Item Chart -->
                    <li>
                        <a class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-active dark:hover:bg-meta-4"
                            href="{{ route('report') }}" @click="selected = (selected === 'Chart' ? '':'Chart')"
                            :class="{ 'bg-active dark:bg-meta-4': (selected === 'Chart') && (page === 'Chart') }">
