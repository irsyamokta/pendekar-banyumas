            ...
            <form action="{{ route('register') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="flex flex-col justify-center items-center px-16 py-16">
                    <div class="mb-5">
                        ...
                        <br>
                        <input type="text" name="nama_lengkap" :value="old('nama_lengkap')" required autofocus autocomplete="nema_lengkap" class="rounded-[30px] w-[250px] lg:w-[300px]">
                    </div>
                    <div class="mb-5">
                    ...
                    <div class="mb-5">
                        ...
                        <br>
                        <input type="password" name="password_confirmation" required autocomplete="current-password" class="rounded-[30px] w-[250px] lg:w-[300px]">
                    </div>
                    <button class="w-40 h-10 mt-5 rounded-[30px] bg-secondary text-primary hover:bg-active hover:text-primary duration-300 ease-linear dark:bg-meta-4 hover:dark:bg-primary">Daftar</button>
                </div>
            </form>
        </div>
    </section>
