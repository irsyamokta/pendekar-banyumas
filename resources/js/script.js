        ...
        addSdqFirst.addEventListener('click', () => {
            ...
            newCard.innerHTML = `
                        <div class="flex flex-col">
                            <div id="toast-warning" class="flex items-center p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-yellow-300 ease-in hidden" role="alert">
